...
| Run an autonomous loop on the dispatch frontier | `node pipeline-cli/bin/cli-orchestrator.mjs start` | **$200/mo Agent SDK credit** (Max-20x), then API-key overflow (post-2026-06-15; uses `claude -p` which the credit covers) |
...
*Last updated: 2026-05-14 (covers post-2026-06-15 Agent SDK credit changes).*
